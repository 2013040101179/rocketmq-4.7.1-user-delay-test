        ...
        try {
            ...
            if (propertiesLength > 0) {
                ...
                // Timing message processing
                {
                    ...
                    String userDelayTimeStr = propertiesMap.get(MessageConst.USER_DELAY_TIME);
                    String originStoreTimeStr = propertiesMap.get(MessageConst.USER_ORIGIN_STORE_TIME);
                    if (TopicValidator.RMQ_SYS_SCHEDULE_TOPIC.equals(topic) && t != null) {
                        ...
                        if (delayLevel > 0) {
                            if (StringUtils.isNoneEmpty(userDelayTimeStr, originStoreTimeStr)) {
                                //user delay time ms
//                                String[] userDelayTimes = StringUtils.split(userDelayTimeStr, ",");
                                tagsCode = Long.valueOf(userDelayTimeStr) + Long.valueOf(originStoreTimeStr);
                            } else {
    ...
    public CompletableFuture<PutMessageResult> asyncPutMessage(final MessageExtBrokerInner msg) {
        ...
        try {
            ...
            if (isUserDelay) {
                MessageAccessor.putProperty(msg, MessageConst.USER_ORIGIN_STORE_TIME, String.valueOf(msg.getStoreTimestamp()));
                msg.setPropertiesString(MessageDecoder.messageProperties2String(msg.getProperties()));
            }
